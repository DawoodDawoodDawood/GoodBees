...
const mapStateToProps = state => ({
  sellerEmail: state.SellerAuthReducer.sellerEmailForResetPassword
});

export default connect(mapStateToProps, { codeVerificationForResetPassword })(
