...
import { buyerLogin } from "../../../store/actions/authActions/authActions";
  ...
  render() {
    if (this.state.loginSuccess) {
      const resetAction = StackActions.reset({
        index: 0,
        actions: [NavigationActions.navigate({ routeName: "BuyerAppDrawer" })]
      });
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.forgetViewStyle}>
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.navigate("BuyerForgetPasswordScreen")
            }
          >
        ...
        <View style={styles.textMainViewStyle}>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate("BuyerSignUpScreen")}
          >
            <Text style={{ color: WHITE_COLOR, fontSize: SMALL }}>
              Create Account
            </Text>
...
const mapStateToProps = state => ({
  loginMsg: state.BuyerAuthReducer.buyerLoginData.msg
});
